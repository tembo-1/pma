...
class __TwigTemplate_30ab97dc6cddea19d22551f9d90e504e extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "C:\\hosting\\phpmyadmin\\templates\\preferences\\header.twig");
    }
}
